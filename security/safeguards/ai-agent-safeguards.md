...
{% hint style="info" %}
**Note:** Messages detected by safeguards are flagged and can be monitored in [Evaluate > Flagged messages](../../dashboard-guide/evaluate/reports/flagged-messages.md).
{% endhint %}
