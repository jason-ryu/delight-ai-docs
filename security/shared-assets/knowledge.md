...
Delight AI supports saving, syncing, deploying, and deleting knowledge items. Updates made in the Development environment do not automatically apply to Staging or Production and must be explicitly deployed.
