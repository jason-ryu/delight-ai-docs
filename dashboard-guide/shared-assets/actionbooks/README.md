...
{% hint style="info" %}
Messenger channels require an actionbook with `/Handoff` to trigger a handoff. Make sure you have [set up a support platform](../../build/channels/messenger/conversation-settings/README.md#transfer-to-human-agent) in your Messenger conversation settings before using this command.
{% endhint %}
