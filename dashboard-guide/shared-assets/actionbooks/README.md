...
{% hint style="info" %}
To hand off conversations to human agents on Messenger channels, you must create an actionbook with the `/Handoff` command. For more information, see [**Build > Channels > Messenger > Conversation settings**](../../build/channels/messenger/conversation-settings/README.md#transfer-to-human-agent).
{% endhint %}
